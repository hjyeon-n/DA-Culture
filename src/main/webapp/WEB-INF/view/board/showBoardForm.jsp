  ...
  <header class="masthead" style="background-image: url('resources/img/form-bg.jpg')">
	...
	<article>
		<div class="container" role="main">
			<form name="form" id="form" role="form" method="post" action="${pageContext.request.contextPath}/showBoard/save">
				<div class="mb-3">
					<label for="showReviewTitle">글 제목</label>
					<input type="text" class="form-control" name="showReviewTitle" id="showReviewTitle" placeholder="글 제목을 입력해 주세요">
				</div>
				<div class="mb-3">
					<label for="showTitle">전시회 제목</label>
					<input type="text" class="form-control" name="showTitle" id="showTitle" placeholder="전시회 제목을 입력해 주세요">
				</div>
				<div class="mb-3">
					<label for="showScore">전시회 평점</label>
					<input type="hidden" name="showScore" id="showScore" value="0.5">
						<div id="starRating">
				...
				<div class="mb-3">
					...
					<textarea name="showReviewContents" id="showReviewContents" rows="5" cols="151"></textarea>
